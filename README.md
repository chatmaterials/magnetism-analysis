...
Standalone skill for magnetism-focused DFT result analysis, including magnetic-state classification, local-moment descriptors, and multi-candidate screening.
...
python3 scripts/screen_magnetic_candidates.py fixtures/compare fixtures/candidates/weak-fm fixtures/candidates/ferri-mixed --target-ground-state ferromagnetic-like --target-moment-min 1.5 --json
